...
DB.load = function() {
    ...
    alasql('CREATE TABLE emp(id INT IDENTITY, number STRING, name_kanji STRING, name_kana STRING, sex INT, birthday DATE, tel STRING, ctct_name STRING, ctct_addr STRING, ctct_tel STRING, pspt_no STRING, pspt_date STRING, pspt_name STRING, rental STRING, password STRING, department INT);');
